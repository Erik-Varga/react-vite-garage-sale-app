...
const Login = ({ userState, setUserState }) => {
    ...
    const signInWithGoogle = async () => {
        ...
        try {
            ...
            if (existingUser) {
                const userRef = doc(fireDB, "user", existingUser.id);
                updateDoc(userRef, {
            ...
            <div className='login'>
                ...
                <span className="hidden">
                    <form onSubmit={loginHandler}>
                        <span className="mt-1 text-sm text-blue-400">using Email & Password</span>
                        <input
                            type="email"
                            name="email"
                            id="email"
                ...
                <button  onClick={signInWithGoogle} type="button" class="text-white bg-woods-rust hover:bg-woods-taupe/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
                ...
                {/* <NavLink to="/register" className='mt-5 link'>Not yet registered? <span className="font-bold text-gray-700 hover:text-black">Register Now</span></NavLink> */}
                <HomeOnlyButton />
            </div>
        </Layout>
    );
