    ...
    <Layout>
      ...
      <div>
        <div className="flex flex-col items-center space-y-2">
          ...
          <h1 className="font2 text-4xl font-bold">Thank You for your Offer!</h1>
          <p>I will get back with you soon.</p>
...
export default ThankYouForOffer