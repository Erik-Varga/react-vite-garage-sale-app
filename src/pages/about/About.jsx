...
import AboutImg from '../../assets/img-ev.jpg';
import Services from '../services/Services'
import DigitalClock from '../../components/digitalClock/DigitalClock'
import Clock from '../../components/clock/Clock'
import { PiBoneDuotone, PiVinylRecord, PiVinylRecordDuotone } from 'react-icons/pi'
import { BsDashCircleDotted } from 'react-icons/bs'
import { CiCompass1 } from 'react-icons/ci'
import FlatClock from '../../components/clock/FlatClock'
import { Gamepad, Puzzle, Gamepad2 } from 'lucide-react'
import PuzzleGameButton from './../../components/buttons/PuzzleGame';
import LightsOutGameButton from '../../components/buttons/LightsOutGameButton'
import Maze from '../../components/maze/Maze'
import MazeGameButton from './../../components/buttons/MazeGameButton';
import Forecast from '../../components/weather/Forecast'

const About = () => {
    const image = "https://images.unsplash.com/photo-1602746423790-8108055c34fe?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";

    const randomImg = "https://picsum.photos/300/500";
    ...
    return (
        <Layout>
            ...
            <div className="bg-white relative flex items-center justify-center overflow-hidden z-50">
                <div className="relative mx-auto h-full px-4 pb-5 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
                    <div className="flex flex-col items-center justify-between lg:flex-row pt-8">
                        <div className=" relative ">
                            <div className=" absolute top-0 -left-96 z-0 opacity-40">
                                <img src={randomImg} className="w-full z-0 h-full object-fill fill-y text-y rounded-md" />
                            </div>
                            <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    Hi there, my name is
                                    <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">Erik</span>
                                </h2>
                                <p className="text-base text-gray-700">
                                    I developed this <span className='font-semibold'>Garage Sale App</span> in order for you to remotely rummage thru my garage... 
                                </p>
                                <p className="mt-2 inline-flex items-center rounded-md bg-blue-50 text-slate-800 px-4 py-3 font-bold ring-1 ring-inset ring-blue-700/10">
                                    All Items are Available & For Sale
                                </p>

                                <ul className='mt-5 max-w-md space-y-2 text-woods-black dark:text-gray-400'>
                                    <li className='flex items-center gap-2'>
                                        <FaCheckCircle className='text-woods-rust' />
                                        Create Free Account
                                    </li>
                                    <li className='flex items-center gap-2'>
                                        <FaCheckCircle className='text-woods-rust' />
                                        Add Items to Cart / Make Offer
                                    </li>
                                    <li className='flex items-center gap-2'>
                                        <FaCheckCircle className='text-woods-rust' />
                                        Pickup Locally & Pay Cash
                                    </li>
                                </ul>
                                
                                <div className="mt-10 flex flex-col items-center md:flex-row">
                                    <ViewItems />
                                    <Link to={"/contact"} className="group inline-flex items-center font-semibold text-g1">
                                        <ContactButton />
                                    ...
                                    <div className="ml-5 animate-spin-slow">
                                        {/* <BsDashCircleDotted size={22} /> */}
                                        <PiBoneDuotone size={22} />
                                        {/* <CiCompass1 size={22} /> */}
                                        
                                        <div className="ml-5 animate-spin">
                                        <PiVinylRecordDuotone size={36} />
                                    </div>
                                    <div className="ml-5 animate-spin-slow">
                                        {/* <PiVinylRecordDuotone size={7} /> */}
                                    </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative lg:ml-32 lg:block lg:w-1/2">
                            ...
                            <div className="abg-orange-400 mx-auto w-80 h-auto overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                                <img src={AboutImg} />
                            </div>
                        </div>
                    </div>                      
                ...
                <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
                    <svg width="800px" height="800px" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="w-48 z-0  h-full -rotate-90   object-fill fill-woods-taupe text-red-300">
                ...
                <div className=" absolute top-10 left-3/4 z-0  opacity-10 ">
                    <svg fill="#000000" width="800px" height="800px" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="w-96 z-0  h-full    object-fill fill-woods-rust text-blue-300">
            ...
            {/* <div>
                <Link to={"/puzzle"} className="group inline-flex items-center font-semibold text-g1">
                    <PuzzleGameButton />
                    <svg xmlns="http://www.w3.org/2000/svg" className="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
            ...
            {/* <div className='flex justify-center'>
                <Link to={"/lightsout"} className="group inline-flex items-center font-semibold text-g1">
                    <LightsOutGameButton />
                </Link>
            </div> */}
